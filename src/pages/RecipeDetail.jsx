...
const RecipeDetail = () => {
  ...
  const getRecipe = async (id) => {
    try {
      ...
      console.log('Recipe fetched:', data) // Agregar registro de consola
      setRecipe(data)
      setLoading(false)
    } catch (error) {
      console.error('Error fetching recipe:', error) // Agregar registro de consola
      setLoading(false)
    }
  }
  ...
  useEffect(() => {
    const fetchRecommended = async () => {
      try {
        ...
        console.log('Recommended recipes fetched:', recommend) // Agregar registro de consola
        setRecipes(recommend)
      } catch (error) {
        console.error('Error fetching recommended recipes:', error) // Agregar registro de consola
      }
    }
